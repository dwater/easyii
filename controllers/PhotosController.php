        ...
        if($photo->image && $photo->validate(['image'])){
            ...
            if($photo->image){
                if($photo->save()){
                    ...
                    @unlink(Yii::getAlias('@uploadsRoot') . str_replace(Url::base(true), '', $photo->image));
            ...
            if($photo->image && $photo->validate(['image'])){
                ...
                if($photo->image){
                    if($photo->save()){
                        ...
                        @unlink(Yii::getAlias('@uploadsRoot').$oldImage);
                        ...
                        @unlink(Yii::getAlias('@uploadsRoot').$photo->image);
