        ...
        <div class="wrapper">
            ...
            <div class="main">
                <div class="box sidebar">
                    ...
                    <a href="<?= Url::to(['/admin/comments']) ?>" class="menu-item <?= ($moduleName == 'admin' && $this->context->id == 'comments') ? 'active' :'' ?>">
                            <i class="glyphicon glyphicon-align-left"></i> 
                            <?= Yii::t('easyii', 'Comments') ?>
                    </a>
                    ...
                    <?php if(IS_ROOT) : ?>
                        ...
                        <a href="<?= Url::to(['/user/admin/']) ?>" class="menu-item <?= ($moduleName == 'user') ? 'active' :'' ?>">
