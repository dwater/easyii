...
class Upload
{
    ...
    static function getUploadPath($dir)
    {
        ...
        $uploadPath = Yii::getAlias('@uploadsRoot').DIRECTORY_SEPARATOR.self::$UPLOADS_DIR.($dir ? DIRECTORY_SEPARATOR.$dir : '');
    ...
    static function getLink($fileName)
    {
        ...
        return str_replace('\\', '/', str_replace(Yii::getAlias('@uploadsRoot'), '', $fileName));
    }
